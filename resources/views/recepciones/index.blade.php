...
@section('contenido')
    <div class="container mb-2">
        <div class="row">
            <div class="col-4">
                <a href="{{route('recepciones.create')}}" class="btn btn-success btn-sm border border-dark {{ setActiva('recepciones/create') }}">
            ...
            <div class="ps-4 col-4 ">
                <form class="ps-4 ms-4 d-inline-block">
                        <div class="input-group">
                            <input name="buscar" class="form-control  border border-dark" type="search" placeholder="Buscar por n° Ornden" aria-label="Search" value="">
                            <input type="text" name="NumOrden" value="1" hidden>
                            <span class="input-group-text  border border-dark" id="basic-addon1">
            ...
            <div class="ps-4 col-4">
                <form class="ps-4 ms-4 d-inline-block">
                    <div class="justify-content-center">
                        <div class="input-group ">
                            <input name="buscar" class="form-control border border-dark" type="search" placeholder="Busqueda avanzada" aria-label="Search" value="{{$buscar}}">
                            <span class="input-group-text border border-dark" id="basic-addon1">
                                    <button style="border:none;" class="p-0">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                        <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"></path>
