    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <td class="text-center">
                <a class="btn btn-primary {{auth()->user()->tieneRol(['admin'])?'':($recepcion->terminada())}}" href="{{route('recepciones.edit',$recepcion)}}">
            ...
            <td class="text-center">
                <form method="POST" action="{{route('recepciones.destroy',$recepcion)}}">
                    @csrf @method('DELETE')
                    <button type="submit" class="btn btn-danger {{$recepcion->terminada()}}" onclick="return confirm('¿Está seguro que desea borrar esta Recepción?')">
            ...
            <td class="text-center">
                <a class="btn btn-info  {{$recepcion->terminada()}}" href="{{route('recepciones.generarPdfIngreso',$recepcion)}}">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-5 text-end"> --}}
                            <a href="{{route('recepciones.informe_final',$recepcion)}}" class="btn btn-primary {{$recepcion->terminada()}}" >
            ...
            <th class="col-8">
                <div class="row">
                    ...
                    <div class="col-7 text-end">
                            ...
                            <a href="{{route('revisiones.create',$recepcion)}}" class="btn btn-primary {{$recepcion->terminada()}}">
