...
@section('contenido')
    <div class="container mb-2">
        <div class="row">
            <div class="col-7">
                <a href="{{route('equipos.create')}}" class="btn btn-success btn-sm border-dark">
            ...
            <div class="card-body p-0">
                <table class="table p-0 m-0 w-100 table-responsive table-info table-hover table-striped table-bordered border-2 border-dark shadow rounded">
                    ...
                    <tr>
                        ...
                        <td class="p-1 text-center col-1"><a href="{{route('equipos.show',$equipo)}}" class="btn btn-sm btn-primary">Ver</a></td>
                    </tr>
                    @empty
                    <tr>
