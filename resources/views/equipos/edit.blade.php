    ...
    <form method="POST" action="{{route('equipos.update',$equipo)}}" class="col-8 mx-auto rounded-3 align-items-center bg-form border border-2 border-dark justify-content-center">
        ...
        <div class="row mx-auto col-11">
            <div class="col-6">
                ...
                <input type="text" class="form-control border-dark" name="numero_serie" value="{{ old('numero_serie',$equipo->numero_serie)}}">
                {!!$errors->first('numero_serie','<small>:message</small>')!!}<br>
            </div>
            <div class="col-6">
                <label for="tipo" class="form-label">Tipo: </label>
                <input type="text" class="form-control border-dark" name="tipo" value="{{ old('tipo',$equipo->caracteristica->tipo->tipo)}}">
        ...
        <div class="row mx-auto col-11">
            <div class="col-6">
                ...
                <input type="text"  class="form-control border-dark" name="modelo" value="{{ old('modelo',$equipo->caracteristica->modelo)}}" >
                {!!$errors->first('modelo','<small>:message</small>')!!}<br>
            </div>
            <div class="col-6">
                <label for="marca" class="form-label">Marca: </label>
                <input type="text" class="form-control border-dark" name="marca" value="{{ old('marca',$equipo->caracteristica->marca->marca)}}">
        ...
        <div class="row mb-0 justify-content-center">
            <div class="col-8">
                ...
                {!!$errors->first('observacion','<small>:message</small>')!!}
        ...
        <div class="row mb-0 justify-content-center mb-2">
            ...
            <div class="col-4 ms-4 w-auto p-1 rounded border border-dark" style="background-color: rgb(232, 240, 247)">
                <a class="btn btn-outline-danger" href="{{ route('equipos.show',$equipo) }}" role="button">
