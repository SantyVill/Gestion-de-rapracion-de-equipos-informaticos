...
@section('contenido')<section class="pb-4 row justify-content-center">
            ...
            <form method="POST" action="{{route('precios.update',$precio)}}" class="align-items-center">
                ...
                <div class="row mb-0 justify-content-center">
                    <div class="col-6">
                        ...
                        <input type="text" name="reparacion" class="form-control" value="{{ old('reparacion',$precio->reparacion)}}" required><br>
                        {!!$errors->first('reparacion','<small>:message</small><br>')!!}
                    </div>
                    <div class="col-6">
                        <label for="precio" class="form-label">Precio </label>
                        <input type="number" name="precio" class="form-control" value="{{ old('precio',$precio->precio)}}" required><br>
                        {!!$errors->first('precio','<small>:message</small><br>')!!}
                </div>
                <div class="row mb-0 justify-content-center">
                    <div class="col-6">
                        <label for="plazo" class="form-label">Plazo </label>
                        <input type="date" name="plazo" class="form-control" value="{{ old('plazo',$precio->plazo)}}" required><br>
                        {!!$errors->first('plazo','<small>:message</small><br>')!!}
                    </div>
                    <div class="col-6">
                        <label for="riesgo" class="form-label">Riesgo </label>
                        <input type="text" name="riesgo" class="form-control" value="{{ old('riesgo',$precio->riesgo)}}" required><br>
