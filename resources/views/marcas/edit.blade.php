...
<section class="m-0-auto  text-center">
    <form method="POST" action="{{route('marcas.update',$marca)}}" class="col-8 mx-auto rounded-3 align-items-center bg-form border border-2 border-dark justify-content-center">
        @csrf @method('PATCH')
