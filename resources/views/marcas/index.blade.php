...
<div class="container mb-2">
    <div class="row">
        <div class="col-7">
            <a href="{{route('marcas.create')}}" class="btn btn-success btn-sm border-dark">
            ...
            <form class="ps-4 ms-4">
                <div class="row justify-content-center">
                    <div class="input-group w-50">
                        <input name="buscar" class="form-control border-dark p-1" type="search" placeholder="Buscar Marca" aria-label="Search" value="{{$buscar}}">
                    ...
                    <tr>
                        ...
                        <td class="py-1">
                            <form method="POST" action="{{route('marcas.destroy',$marca)}}">
                                @csrf @method('DELETE')
                                <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('¿Está seguro que desea borrar la marca {{$marca->marca}}? Se eliminarán tambien sus modelos y listas de precios.')">
