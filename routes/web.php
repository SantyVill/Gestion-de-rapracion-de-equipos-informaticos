...
Route::post('/equipos/storeRecepcion/',[App\Http\Controllers\EquiposController::class,'storeRecepcion'])->name('equipos.storeRecepcion')->middleware(['logueo','rol:recepcionista,admin']);
Route::get('/equipos/createRecepcion/',[App\Http\Controllers\EquiposController::class,'createRecepcion'])->name('equipos.createRecepcion')->middleware(['logueo','rol:recepcionista,admin']);
...
Route::get('/clientes/createRecepcion/',[App\Http\Controllers\ClientesController::class,'createRecepcion'])->name('clientes.createRecepcion')->middleware(['logueo','rol:recepcionista,admin']);
